...
@OpenAPIDefinition(info = @Info(contact = @Contact(name = "John Smith", email = "john.s@iamneo.ai", url = "https://some-url.com"), description = "This is open api documentation ", title = "Home Appliance Service Centre", version = "1.0", license = @License(name = "MIT", url = "https://some-url.com"), termsOfService = "Terms of service"), servers = @Server(description = "DEV ENV", url = Api.DEFAULT))
